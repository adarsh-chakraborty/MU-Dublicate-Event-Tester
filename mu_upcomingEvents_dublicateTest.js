...
async function getPastEvents() {
    ...
    while (currentPage <= totalPages) {
      ...
      const response = await fetch(`http://localhost:32000/api/getUpcomingEventsMastersunion?page=${currentPage}`);
  ...
  getPastEvents()
    .then(allEvents => {
        ...
        fs.writeFileSync("mupastevents.json", JSON.stringify(allEvents));
