...
async function getPastEvents() {
    ...
    while (currentPage <= totalPages) {
      ...
      const response = await fetch(`http://localhost:32000/api/getUpcomingEventsMastersunion?page=${currentPage}&eLoc=Online`);
      ...
      const { upcomingEvents, totalPages: total, currentPage: page } = responseData.Data;
  ...
  getPastEvents()
    .then(allEvents => {
        ...
        fs.writeFileSync("mu_onlineUpcomingEvents_dubTest.json", JSON.stringify(allEvents));
